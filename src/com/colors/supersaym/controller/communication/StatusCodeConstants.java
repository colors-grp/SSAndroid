...
public class StatusCodeConstants {
	...
	public final static int STATUS_CODE_UNKNOWN_HOST_EXCEPTION= -1;
	public final static int STATUS_CODE_HTTP_HOST_CONNECTION_EXCEPTION= -2;
	public final static int STATUS_CODE_IO_EXCEPTION= -3;
	public final static int STATUS_CODE_EXCEPTION= -4;
	public final static int STATUS_CODE_NO_CONNECTION = -5;
